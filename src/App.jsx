...
<section id="header">
    ...
    <section id="destination-section">
        ...
        <div className="box-wrap">
            ...
            <div className="set-box">
                <img src="images/Chidambaram.png" />
            ...
            <div className="set-box">
                <img src="images/Kumbakkonam.png" />
            ...
            <div className="set-box">
                <img src="images/Tirunalveli.png" />
